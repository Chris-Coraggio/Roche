...
public class GUI extends javax.swing.JDialog {
	...
	private Icon picture = null; // instance of picture after most recent
									// picture taken
	...
	public GUI(String name, String phone, String email) {
		...
		pictureLabel.setIcon(new ImageIcon(createAwtImage(f)));
		try {
			initProjectNumber();
				...
				while (picture == null) {
					...
					try {
						if (frame.width() > 0 && frame.height() > 0)
							GUI.pictureLabel.setIcon(new ImageIcon(createAwtImage(frame)));
					} catch (Exception e) {
						// TODO Auto-generated catch block
						e.printStackTrace();
					}
	...
	public void initProjectNumber() throws IOException {
		...
		try {
			Driver.setProjectNum(Integer.valueOf(br.readLine()));
				...
				.addGroup(layout.createSequentialGroup().addContainerGap()
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
								.addGroup(layout.createSequentialGroup()
										.addComponent(jButton3, javax.swing.GroupLayout.PREFERRED_SIZE, 205,
												javax.swing.GroupLayout.PREFERRED_SIZE)
										.addGap(30, 30, 30).addComponent(jButton2,
												javax.swing.GroupLayout.PREFERRED_SIZE, 237,
												javax.swing.GroupLayout.PREFERRED_SIZE))
								.addComponent(pictureLabel, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
						.addGap(GAP_SIZE, GAP_SIZE, GAP_SIZE).addGroup(layout.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
								.addGroup(layout.createSequentialGroup()
										.addGap(GAP_SIZE, GAP_SIZE, GAP_SIZE).addComponent(jLabel10,
								...
								.addGroup(layout.createSequentialGroup()
										...
										.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
												...
												.addComponent(jScrollPane2, javax.swing.GroupLayout.DEFAULT_SIZE, 594,
														Short.MAX_VALUE)
								...
								.addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
										.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
												.addComponent(jButton1, javax.swing.GroupLayout.DEFAULT_SIZE,
														javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
												.addComponent(jLabel7, javax.swing.GroupLayout.DEFAULT_SIZE, 350,
														Short.MAX_VALUE)
										...
										.addGroup(layout
												.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
												.addComponent(jButton5, javax.swing.GroupLayout.DEFAULT_SIZE, 345,
														Short.MAX_VALUE)
												...
												layout.createSequentialGroup()
														...
														.addGroup(layout
																...
																.addComponent(jButton5,
																		...
																		javax.swing.GroupLayout.PREFERRED_SIZE))
														.addGap(30, 30, 30).addComponent(jLabel10,
																javax.swing.GroupLayout.PREFERRED_SIZE, 49,
																javax.swing.GroupLayout.PREFERRED_SIZE))
										.addGroup(layout.createSequentialGroup().addGap(GAP_SIZE, GAP_SIZE, GAP_SIZE)
												.addComponent(pictureLabel, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE,
														javax.swing.GroupLayout.PREFERRED_SIZE)
												.addGap(GAP_SIZE, GAP_SIZE, GAP_SIZE)
												.addGroup(layout
	...
	private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) throws IOException { // generate
																								// label
		jLabel10.setText("Submitting Sample...");
		ArrayList<String> tests = compileTests();
		Document d = new Document((jTextField1.getText() != null ? jTextField1.getText() : ""),
				...
				tests, (javax.swing.ImageIcon) picture, this.name, this.phone, this.email);
		d.makeLabel();
		doc = d;
		jLabel10.setText("Sample Submitted at " + new SimpleDateFormat("HH:mm:ss").format(new Date()));
	}

	private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) { // take
																			// picture
	...
	private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) { // reset
																			// picture
		picture = null;
		jButton2.setEnabled(true);
	}

	private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) { // log
																			// out
		try {
			writeProjectNumber();
		} catch (IOException e) {
	...
	public void printString(String s) {
		PrintLabel p = new PrintLabel(doc.getID(), doc.getName(), doc.getProjectNumber(), doc.getSubmitterName(),
				doc.getTests());
	}
	...
	private void assignStuffToButtons() {
		testsCheckboxes = Arrays.asList(jCheckBox1, jCheckBox2, jCheckBox3, jCheckBox4, jCheckBox5, jCheckBox6,
